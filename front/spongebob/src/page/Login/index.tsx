...
const Login = () => {
    return (
        <UserBackGroundConteiner>
            <ColorDiv blur="200px" top="-250px" right="500px" width="800px" height="700px" background="#2e86de"></ColorDiv>
            ...
            <ColorDiv blur="200px" top="-100px" left="-100px" width="500px" height="500px" background="#ff6b6b"></ColorDiv>
            <Box>
